...
Section MmioRawLayer.
  ...
  Section InvDef.
    ...
    Global Instance MmioRaw_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance MmioRaw_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance host_get_mmio_data_inv: PreservesInvariants host_get_mmio_data_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition MmioRaw_fresh : compatlayer (cdata RData) :=
    ...
    Definition MmioRaw_passthrough : compatlayer (cdata RData) :=
    ...
    Definition MmioRaw := MmioRaw_fresh ⊕ MmioRaw_passthrough.
