...
Section NPTWalkLayer.
  ...
  Section InvDef.
    ...
    Global Instance NPTWalk_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance NPTWalk_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance walk_npt_inv: PreservesInvariants walk_npt_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance get_npt_level_inv: PreservesInvariants get_npt_level_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance set_npt_inv: PreservesInvariants set_npt_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition NPTWalk_fresh : compatlayer (cdata RData) :=
    ...
    Definition NPTWalk_passthrough : compatlayer (cdata RData) :=
    ...
    Definition NPTWalk := NPTWalk_fresh ⊕ NPTWalk_passthrough.
