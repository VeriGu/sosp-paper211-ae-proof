...
Section MmioCoreLayer.
  ...
  Section InvDef.
    ...
    Global Instance MmioCore_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance MmioCore_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance handle_smmu_write_inv: PreservesInvariants handle_smmu_write_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_smmu_read_inv: PreservesInvariants handle_smmu_read_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition MmioCore_fresh : compatlayer (cdata RData) :=
      handle_smmu_write ↦ gensem handle_smmu_write_spec
          ⊕ handle_smmu_read ↦ gensem handle_smmu_read_spec.

    Definition MmioCore_passthrough : compatlayer (cdata RData) :=
    ...
    Definition MmioCore := MmioCore_fresh ⊕ MmioCore_passthrough.
