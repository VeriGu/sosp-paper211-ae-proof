...
Section MmioPTWalkLayer.
  ...
  Section InvDef.
    ...
    Global Instance MmioPTWalk_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance MmioPTWalk_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance walk_smmu_pgd_inv: PreservesInvariants walk_smmu_pgd_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance walk_smmu_pte_inv: PreservesInvariants walk_smmu_pte_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance walk_smmu_pmd_inv: PreservesInvariants walk_smmu_pmd_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance set_smmu_pte_inv: PreservesInvariants set_smmu_pte_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition MmioPTWalk_fresh : compatlayer (cdata RData) :=
    ...
    Definition MmioPTWalk_passthrough : compatlayer (cdata RData) :=
    ...
    Definition MmioPTWalk := MmioPTWalk_fresh ⊕ MmioPTWalk_passthrough.
