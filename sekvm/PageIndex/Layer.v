...
Section PageIndexLayer.
  ...
  Section InvDef.
    ...
    Global Instance PageIndex_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance PageIndex_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance get_s2_page_index_inv: PreservesInvariants get_s2_page_index_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition PageIndex_fresh : compatlayer (cdata RData) :=
      get_s2_page_index ↦ gensem get_s2_page_index_spec.

    Definition PageIndex_passthrough : compatlayer (cdata RData) :=
    ...
    Definition PageIndex := PageIndex_fresh ⊕ PageIndex_passthrough.
