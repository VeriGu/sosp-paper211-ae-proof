...
Section LockOpsHLayer.
  ...
  Section InvDef.
    ...
    Global Instance LockOpsH_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance LockOpsH_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance pass_hlock_inv: PreservesInvariants pass_hlock_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance wait_hlock_inv: PreservesInvariants wait_hlock_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition LockOpsH_fresh : compatlayer (cdata RData) :=
      pass_hlock ↦ gensem pass_hlock_spec
    ⊕ wait_hlock ↦ gensem wait_hlock_spec
    .

    Definition LockOpsH_passthrough : compatlayer (cdata RData) :=
    ...
    Definition LockOpsH := LockOpsH_fresh ⊕ LockOpsH_passthrough.
