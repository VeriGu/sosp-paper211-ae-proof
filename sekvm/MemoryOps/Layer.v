...
Section MemoryOpsLayer.
  ...
  Section InvDef.
    ...
    Global Instance MemoryOps_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance MemoryOps_prf : CompatData RData.
    Proof.
  ...
  Section LayerDef.
    ...
    Definition MemoryOps_fresh : compatlayer (cdata RData) :=
    ...
    Definition MemoryOps_passthrough : compatlayer (cdata RData) :=
    ...
    Definition MemoryOps := MemoryOps_fresh ⊕ MemoryOps_passthrough.
