...
Section BootOpsLayer.
  ...
  Section InvDef.
    ...
    Global Instance BootOps_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance BootOps_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance is_inc_exe_inv: PreservesInvariants is_inc_exe_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition BootOps_passthrough : compatlayer (cdata RData) :=
    ...
    Definition BootOps := BootOps_fresh ⊕ BootOps_passthrough.
