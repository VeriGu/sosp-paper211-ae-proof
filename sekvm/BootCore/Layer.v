...
Section BootCoreLayer.
  ...
  Section InvDef.
    ...
    Global Instance BootCore_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance BootCore_prf : CompatData RData.
    Proof.
  ...
  Section LayerDef.
    ...
    Definition BootCore_fresh : compatlayer (cdata RData) :=
      gen_vmid ↦ gensem gen_vmid_spec
          ⊕ alloc_remap_addr ↦ gensem alloc_remap_addr_spec.

    Definition BootCore_passthrough : compatlayer (cdata RData) :=
    ...
    Definition BootCore := BootCore_fresh ⊕ BootCore_passthrough.
