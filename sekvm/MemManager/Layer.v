...
Section MemManagerLayer.
  ...
  Section InvDef.
    ...
    Global Instance MemManager_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance MemManager_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance revoke_vm_page_inv: PreservesInvariants revoke_vm_page_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance assign_pfn_to_smmu_inv: PreservesInvariants assign_pfn_to_smmu_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance assign_pfn_to_vm_inv: PreservesInvariants assign_pfn_to_vm_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance unmap_smmu_page_inv: PreservesInvariants unmap_smmu_page_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance map_vm_io_inv: PreservesInvariants map_vm_io_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance grant_vm_page_inv: PreservesInvariants grant_vm_page_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance map_pfn_vm_inv: PreservesInvariants map_pfn_vm_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance update_smmu_page_inv: PreservesInvariants update_smmu_page_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance clear_vm_page_inv: PreservesInvariants clear_vm_page_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition MemManager_fresh : compatlayer (cdata RData) :=
    ...
    Definition MemManager_passthrough : compatlayer (cdata RData) :=
    ...
    Definition MemManager := MemManager_fresh ⊕ MemManager_passthrough.
