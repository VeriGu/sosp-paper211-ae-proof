...
Section MmioCoreAuxLayer.
  ...
  Section InvDef.
    ...
    Global Instance MmioCoreAux_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance MmioCoreAux_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance __handle_smmu_write_inv: PreservesInvariants __handle_smmu_write_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_smmu_global_access_inv: PreservesInvariants handle_smmu_global_access_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_smmu_cb_access_inv: PreservesInvariants handle_smmu_cb_access_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance __handle_smmu_read_inv: PreservesInvariants __handle_smmu_read_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance smmu_get_cbndx_inv: PreservesInvariants smmu_get_cbndx_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition MmioCoreAux_fresh : compatlayer (cdata RData) :=
    ...
    Definition MmioCoreAux_passthrough : compatlayer (cdata RData) :=
    ...
    Definition MmioCoreAux := MmioCoreAux_fresh ⊕ MmioCoreAux_passthrough.

  End LayerDef.

End MmioCoreAuxLayer.
