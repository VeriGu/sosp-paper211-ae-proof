...
Section NPTOpsLayer.
  ...
  Section InvDef.
    ...
    Global Instance NPTOps_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance NPTOps_prf : CompatData RData.
    Proof.
  ...
  Section LayerDef.
    ...
    Definition NPTOps_fresh : compatlayer (cdata RData) :=
    ...
    Definition NPTOps_passthrough : compatlayer (cdata RData) :=
    ...
    Definition NPTOps := NPTOps_fresh ⊕ NPTOps_passthrough.
