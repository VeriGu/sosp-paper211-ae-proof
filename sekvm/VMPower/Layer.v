...
Section VMPowerLayer.
  ...
  Section InvDef.
    ...
    Global Instance VMPower_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance VMPower_prf : CompatData RData.
    Proof.
  ...
  Section LayerDef.
    ...
    Definition VMPower_fresh : compatlayer (cdata RData) :=
      get_vm_poweron ↦ gensem get_vm_poweron_spec
          ⊕ set_vm_poweroff ↦ gensem set_vm_poweroff_spec.

    Definition VMPower_passthrough : compatlayer (cdata RData) :=
    ...
    Definition VMPower := VMPower_fresh ⊕ VMPower_passthrough.
