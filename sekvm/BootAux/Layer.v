...
Section BootAuxLayer.
  ...
  Section InvDef.
    ...
    Global Instance BootAux_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance BootAux_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance unmap_and_load_vm_image_inv: PreservesInvariants unmap_and_load_vm_image_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance alloc_remap_addr_inv: PreservesInvariants alloc_remap_addr_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance gen_vmid_inv: PreservesInvariants gen_vmid_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition BootAux_fresh : compatlayer (cdata RData) :=
      unmap_and_load_vm_image ↦ gensem unmap_and_load_vm_image_spec.

    Definition BootAux_passthrough : compatlayer (cdata RData) :=
    ...
    Definition BootAux := BootAux_fresh ⊕ BootAux_passthrough.
