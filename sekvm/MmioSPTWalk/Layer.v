...
Section MmioSPTWalkLayer.
  ...
  Section InvDef.
    ...
    Global Instance MmioSPTWalk_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance MmioSPTWalk_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance walk_smmu_pt_inv: PreservesInvariants walk_smmu_pt_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance set_smmu_pt_inv: PreservesInvariants set_smmu_pt_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance clear_smmu_pt_inv: PreservesInvariants clear_smmu_pt_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition MmioSPTWalk_fresh : compatlayer (cdata RData) :=
    ...
    Definition MmioSPTWalk_passthrough : compatlayer (cdata RData) :=
    ...
    Definition MmioSPTWalk := MmioSPTWalk_fresh ⊕ MmioSPTWalk_passthrough.

  End LayerDef.

End MmioSPTWalkLayer.
