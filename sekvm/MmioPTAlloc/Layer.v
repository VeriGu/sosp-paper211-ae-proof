...
Section MmioPTAllocLayer.
  ...
  Section InvDef.
    ...
    Global Instance MmioPTAlloc_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance MmioPTAlloc_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance alloc_smmu_pgd_page_inv: PreservesInvariants alloc_smmu_pgd_page_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance alloc_smmu_pmd_page_inv: PreservesInvariants alloc_smmu_pmd_page_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition MmioPTAlloc_fresh : compatlayer (cdata RData) :=
      alloc_smmu_pgd_page ↦ gensem alloc_smmu_pgd_page_spec
          ⊕ alloc_smmu_pmd_page ↦ gensem alloc_smmu_pmd_page_spec.

    Definition MmioPTAlloc_passthrough : compatlayer (cdata RData) :=
    ...
    Definition MmioPTAlloc := MmioPTAlloc_fresh ⊕ MmioPTAlloc_passthrough.

  End LayerDef.

End MmioPTAllocLayer.
