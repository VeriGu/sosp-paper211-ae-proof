...
Section AbstractMachineLayer.
  ...
  Section InvDef.
    ...
    Global Instance AbstractMachine_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance AbstractMachine_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance incr_ticket_inv: PreservesInvariants incr_ticket_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance get_now_inv: PreservesInvariants get_now_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance incr_now_inv: PreservesInvariants incr_now_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance log_hold_inv: PreservesInvariants log_hold_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition AbstractMachine : compatlayer (cdata RData) :=
