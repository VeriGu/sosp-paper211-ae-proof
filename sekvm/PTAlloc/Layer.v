...
Section PTAllocLayer.
  ...
  Section InvDef.
    ...
    Global Instance PTAlloc_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance PTAlloc_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance alloc_pud_page_inv: PreservesInvariants alloc_pud_page_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance alloc_pmd_page_inv: PreservesInvariants alloc_pmd_page_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance alloc_pgd_page_inv: PreservesInvariants alloc_pgd_page_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition PTAlloc_fresh : compatlayer (cdata RData) :=
    ...
    Definition PTAlloc_passthrough : compatlayer (cdata RData) :=
    ...
    Definition PTAlloc := PTAlloc_fresh ⊕ PTAlloc_passthrough.
