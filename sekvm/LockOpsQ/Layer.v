...
Section LockOpsQLayer.
  ...
  Section InvDef.
    ...
    mkInvariant {
        CPU_ID_range: 0 <= abd.(curid) < TOTAL_CPU;
        qlock_pool_length_inv: qlock_pool_length abd.(log);
        valid_qlock_pool_status_inv: correct_qlock_pool_status abd.(log) abd.(lock) abd.(curid);

        valid_qlock_pool_inv: valid_qlock_pool abd.(log);
        valid_multi_oracle_pool_inv: valid_multi_oracle_pool abd.(oracle);

        valid_last_pool_inv: valid_last_pool abd.(curid) abd.(log)
        ...
        (* cal_qlock_pool_status_inv: cal_qlock_pool_status (multi_log abd) (lock abd) (CPU_ID abd); *)
        (* get_free_qlock_pool_inv: get_free_qlock_pool (multi_log abd); *)
        (* valid_from_inv: valid_from_pool (CPU_ID abd) (multi_log abd) (multi_oracle abd) *)
      }.

    Global Instance LockOpsQ_ops : CompatDataOps RData :=
      {
        empty_data := empty_adt;
        high_level_invariant := (fun d => True);
  ...
  Section InvInit.
    ...
    Global Instance LockOpsQ_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance wait_qlock_inv: PreservesInvariants wait_qlock_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance pass_qlock_inv: PreservesInvariants pass_qlock_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance acquire_shared_inv: PreservesInvariants acquire_shared_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance release_shared_pt_inv: PreservesInvariants release_shared_pt_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance release_shared_spt_inv: PreservesInvariants release_shared_spt_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance release_shared_s2page_inv: PreservesInvariants release_shared_s2page_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance release_shared_core_inv: PreservesInvariants release_shared_core_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance release_shared_vm_inv: PreservesInvariants release_shared_vm_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance release_shared_smmu_inv: PreservesInvariants release_shared_smmu_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance get_mem_region_flag_inv: PreservesInvariants get_mem_region_flag_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance get_pud_next_inv: PreservesInvariants get_pud_next_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance get_int_new_level_inv: PreservesInvariants get_int_new_level_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance get_smmu_pgshift_inv: PreservesInvariants get_smmu_pgshift_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance get_pmd_next_inv: PreservesInvariants get_pmd_next_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance pt_load_inv: PreservesInvariants pt_load_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.

    Global Instance get_vm_vcpu_inv: PreservesInvariants get_vm_vcpu_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance set_pt_vttbr_inv: PreservesInvariants set_pt_vttbr_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance set_pud_next_inv: PreservesInvariants set_pud_next_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance pt_store_inv: PreservesInvariants pt_store_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance get_pgd_next_inv: PreservesInvariants get_pgd_next_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance set_pgd_next_inv: PreservesInvariants set_pgd_next_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance set_pmd_next_inv: PreservesInvariants set_pmd_next_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
    ...
    Global Instance get_vm_kvm_inv: PreservesInvariants get_vm_kvm_spec.
    Proof.
      constructor; intros; simpl; eauto.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition LockOpsQ_fresh : compatlayer (cdata RData) :=
      wait_qlock ↦ gensem wait_qlock_spec
    ⊕ pass_qlock ↦ gensem pass_qlock_spec.

    Definition LockOpsQ_passthrough : compatlayer (cdata RData) :=
      acquire_shared ↦ gensem acquire_shared_spec
    ⊕ release_pt_shared ↦ gensem release_shared_pt_spec
    ⊕ release_spt_shared ↦ gensem release_shared_spt_spec
    ⊕ release_s2page_shared ↦ gensem release_shared_s2page_spec
    ⊕ release_core_shared ↦ gensem release_shared_core_spec
    ⊕ release_vm_shared ↦ gensem release_shared_vm_spec
    ⊕ release_smmu_shared ↦ gensem release_shared_smmu_spec
    ⊕ get_mem_region_flag ↦ gensem get_mem_region_flag_spec
    ...
    ⊕ get_smmu_pgshift ↦ gensem get_smmu_pgshift_spec
    ...
    ⊕ get_vm_vcpu ↦ gensem get_vm_vcpu_spec
    ...
    ⊕ set_pt_vttbr ↦ gensem set_pt_vttbr_spec
    ...
    ⊕ get_vm_kvm ↦ gensem get_vm_kvm_spec
    ...
    Definition LockOpsQ := LockOpsQ_fresh ⊕ LockOpsQ_passthrough.
