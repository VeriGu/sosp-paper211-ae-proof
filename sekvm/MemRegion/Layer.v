...
Section MemRegionLayer.
  ...
  Section InvDef.
    ...
    Global Instance MemRegion_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance MemRegion_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance mem_region_search_inv: PreservesInvariants mem_region_search_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition MemRegion_fresh : compatlayer (cdata RData) :=
      mem_region_search ↦ gensem mem_region_search_spec.

    Definition MemRegion_passthrough : compatlayer (cdata RData) :=
    ...
    Definition MemRegion := MemRegion_fresh ⊕ MemRegion_passthrough.
